...
class Food extends React.Component {
  ...
  foodAddFirst(_index,index){
    this.props.addFirst(_index,index);
  }
        ...
        <div className="food-content">
          ...
          <div className="content">
            ...
            <div className="cartcontrol-wrapper">
              <Cartcontrol food = {food} addCount = {this.props.addCount.bind(this,this.props._index,this.props.index)} decreaseCount = {this.props.decreaseCount.bind(this,this.props._index,this.props.index)} _index={this.props._index} index={this.props.index} />
            </div>
